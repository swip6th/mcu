...
// FIXME: bit postion should be corrected.
#define IGP1            14
#define INP1            12
#define EIEN1           11
#define FEN1            8
...
// FIXME: address should be corrected.
#define SRC_SCUERU1     (*(volatile unsigned int*)(SRC_BASE + 0xCD4))
// FIXME: end of FIXME
...
// FIXME: Priority should be corrected.
