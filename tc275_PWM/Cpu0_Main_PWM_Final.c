...
#define LIGHT_SENSOR_MAX    3000
            //light_sensor = (light_sensor-LIGHT_SENSOR_MIN)/(LIGHT_SENSOR_MAX-LIGHT_SENSOR_MIN)*4095;
            if( light_sensor > LIGHT_SENSOR_MAX )
                light_sensor = 4095;
            else if( light_sensor < LIGHT_SENSOR_MIN )
                light_sensor = 0;
            else
                light_sensor = ((light_sensor-LIGHT_SENSOR_MIN)*4095)/(LIGHT_SENSOR_MAX-LIGHT_SENSOR_MIN);
